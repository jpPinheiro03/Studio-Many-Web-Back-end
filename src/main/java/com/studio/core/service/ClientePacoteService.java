...
public class ClientePacoteService {
    ...
    public List<ClientePacoteResponseDTO> findAll() {
        return repository.findAll().stream()
            .map(ClientePacoteResponseDTO::fromEntity)
            .collect(Collectors.toList());
    }
    
    public ClientePacoteResponseDTO findById(Long id) {
        return ClientePacoteResponseDTO.fromEntity(repository.findById(id)
    ...
    public ClientePacoteResponseDTO create(ClientePacoteRequestDTO dto) {
        ...
        clientePacote.setCliente(clienteRepository.findById(dto.getClienteId())
        ...
        if (pacote.getValidadeDias() != null) {
            clientePacote.setDataValidade(LocalDate.now().plusDays(pacote.getValidadeDias()));
        }
        
        return ClientePacoteResponseDTO.fromEntity(repository.save(clientePacote));
    }
    ...
    public ClientePacoteResponseDTO usarSessao(Long id) {
        ...
        return ClientePacoteResponseDTO.fromEntity(repository.save(cp));
    }
